...
class MachineChartInMinsWidget extends StatelessWidget {
  final String? title;
  ...
  const MachineChartInMinsWidget({
    Key? key,
    this.title,
    this.weeklyData,
    this.monthlyData,
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                _buildLegendItem('Reason 1', const Color(0xFF4DD0E1)),
                const SizedBox(width: 16),
                _buildLegendItem('Reason 2', const Color(0xFFFF9800)),
                const SizedBox(width: 16),
                _buildLegendItem('Reason 3', const Color.fromARGB(255, 0, 158, 34)),
              ],
            ),
            const SizedBox(height: 16),
            Expanded(
        ...
        groups.add(
          BarChartGroupData(
            ...
            barRods: [
              ...
              BarChartRodData(
                toY: (item['Reason3'] ?? 0).toDouble(),
                color: const Color.fromARGB(255, 0, 158, 34),
                width: 20,
                borderRadius: const BorderRadius.only(
                  topLeft: Radius.circular(4),
                  topRight: Radius.circular(4),
