...
import 'package:smartmachine365/web_app_template/machine_k_p_i/machine_chart_in_mins_widget.dart';
import 'package:smartmachine365/web_app_template/machine_k_p_i/machine_chart_in_percent_widget.dart';
import 'package:smartmachine365/web_app_template/machine_k_p_i/machine_chart_in_units_widget.dart';
import 'package:smartmachine365/web_app_template/machine_k_p_i/machine_filter_controls_widget.dart';
import 'package:smartmachine365/web_app_template/machine_k_p_i/machine_kpi_metrics_widget.dart';
...
import 'machine_k_p_i_model.dart';

class MachineKPIWidget extends StatefulWidget {
  const MachineKPIWidget({super.key});

  @override
  State<MachineKPIWidget> createState() => _MachineKPIWidgetState();
}

class _MachineKPIWidgetState extends State<MachineKPIWidget> {
  late MachineKPIModel _model;
  ...
  final GlobalKey _machinePerformanceChartKey = GlobalKey();
  final GlobalKey _machineDowntimeChartKey = GlobalKey();

  @override
  void initState() {
    super.initState();
    _model = createModel(context, () => MachineKPIModel());
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                HeaderWidget(
                                  title: 'SM365 Machine KPI Dashboard',
                                ...
                                RepaintBoundary(
                                  ...
                                  child: SizedBox(
                                    height: 400,
                                    child: MachineChartInPercentWidget(
                                ...
                                RepaintBoundary(
                                  ...
                                  child: SizedBox(
                                    height: 400,
                                    child: MachineChartInUnitsWidget(
                                      title: "Total Output by Machine",
                                      weeklyData: oeeData,
                                      monthlyData: oeeData,
                                      yearlyData: oeeData,
                                      selectedShift: selectedShift,
                                ...
                                const SizedBox(height: 24),
                                RepaintBoundary(
                                  key: _machinePerformanceChartKey,
                                  child: SizedBox(
                                    height: 400,
                                    child: MachineChartInPercentWidget(
                                ...
                                const SizedBox(height: 24),
                                RepaintBoundary(
                                  key: _machineDowntimeChartKey,
                                  child: SizedBox(
                                    height: 400,
                                    child: MachineChartInMinsWidget(
                                      title: "Downtime Analysis of Machine",
                                      weeklyData: oeeData,
                                      monthlyData: oeeData,
                                      yearlyData: oeeData,
                                      selectedShift: selectedShift,
